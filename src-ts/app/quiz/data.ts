  ...
  'pt-BR': [
    {
      ...
      correct: 1,
      explanation:
        '✅ Correto! No SDD, a especificação explicita intenção, restrições e critérios verificáveis antes de orientar código, testes e documentação.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correto! Specs reduzem ambiguidade e dão aos agentes um contrato rastreável para planejar, implementar e verificar o resultado.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correto! AGENTS.md funciona como orientação persistente: explica como trabalhar no repositório sem substituir a spec da tarefa ativa.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correto! Uma Agent Skill organiza uma capacidade especializada; SKILL.md é seu ponto de entrada para instruções e recursos associados.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correto! Progressive Disclosure começa com metadata e orientação curta, abrindo detalhes e recursos apenas quando forem relevantes.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correto! Contexto útil é o subconjunto relevante para decidir e agir; preencher a janela pode aumentar custo, latência, distração e risco.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correto! Smart Zone não é um número universal; é uma faixa operacional calibrada por modelo, workload, risco e qualidade observada.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correto! Uma Vertical Slice atravessa as camadas necessárias para produzir um comportamento pequeno, demonstrável e verificável.',
    },
    {
      ...
      correct: 3,
      explanation:
        '✅ Correto! Um handoff compacto preserva o estado necessário para continuar com segurança, sem obrigar a próxima sessão a reconstruir toda a história.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correto! Routing responsável considera risco, fase e evidência; o custo real inclui contexto, tools, retries, infraestrutura, verificação e review.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correto! O harness conecta intenção a execução confiável com ambiente, ferramentas, limites, estado e sensores que produzem evidência.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correto! Um loop confiável é limitado e observável: reconcilia estado, verifica progresso e termina por sucesso, bloqueio, budget ou decisão humana.',
    },
  ],
  'en-US': [
    {
      ...
      correct: 1,
      explanation:
        '✅ Correct! In SDD, the specification captures intent, constraints, and verifiable criteria before guiding code, tests, and documentation.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correct! Specs reduce ambiguity and give agents a traceable contract for planning, implementation, and verification.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correct! AGENTS.md provides persistent repository guidance without replacing the specification for the active task.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correct! An Agent Skill packages a specialized capability, and SKILL.md is its entry point for instructions and related resources.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correct! Progressive Disclosure starts with concise guidance and opens detailed instructions and resources only when relevant.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correct! Useful context is the relevant subset needed to decide and act; filling the window can add cost, latency, distraction, and risk.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correct! The Smart Zone is not universal; it is calibrated by model, workload, risk, and observed quality.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correct! A Vertical Slice crosses the layers needed to produce a small, demonstrable, and independently verifiable behavior.',
    },
    {
      ...
      correct: 3,
      explanation:
        '✅ Correct! A compact handoff preserves the state required to continue safely without forcing the next session to reconstruct the full history.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correct! Responsible routing considers risk, phase, and evidence; total cost includes context, tools, retries, infrastructure, verification, and review.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ Correct! The harness connects intent to reliable execution through environment, tools, boundaries, state, and sensors that produce evidence.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ Correct! A reliable loop is bounded and observable: it reconciles state, verifies progress, and stops on success, blockage, budget, or human decision.',
    },
  ],
  'es-ES': [
    {
      ...
      correct: 1,
      explanation:
        '✅ ¡Correcto! En SDD, la especificación captura intención, restricciones y criterios verificables antes de guiar código, pruebas y documentación.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ ¡Correcto! Las specs reducen ambigüedad y dan a los agentes un contrato trazable para planificar, implementar y verificar.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ ¡Correcto! AGENTS.md ofrece orientación persistente del repositorio sin sustituir la especificación de la tarea activa.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ ¡Correcto! Una Agent Skill empaqueta una capacidad especializada y SKILL.md es su punto de entrada para instrucciones y recursos relacionados.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ ¡Correcto! Progressive Disclosure comienza con orientación breve y abre instrucciones y recursos detallados solo cuando son relevantes.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ ¡Correcto! El contexto útil es el subconjunto relevante para decidir y actuar; llenar la ventana puede añadir coste, latencia, distracción y riesgo.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ ¡Correcto! La Smart Zone no es universal; se calibra según modelo, workload, riesgo y calidad observada.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ ¡Correcto! Una Vertical Slice atraviesa las capas necesarias para producir un comportamiento pequeño, demostrable y verificable de forma independiente.',
    },
    {
      ...
      correct: 3,
      explanation:
        '✅ ¡Correcto! Un handoff compacto preserva el estado necesario para continuar con seguridad sin reconstruir toda la historia.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ ¡Correcto! El routing responsable considera riesgo, fase y evidencia; el coste total incluye contexto, tools, retries, infraestructura, verificación y review.',
    },
    {
      ...
      correct: 2,
      explanation:
        '✅ ¡Correcto! El harness conecta intención y ejecución fiable mediante entorno, herramientas, límites, estado y sensores que producen evidencia.',
    },
    {
      ...
      correct: 1,
      explanation:
        '✅ ¡Correcto! Un loop fiable está limitado y es observable: reconcilia estado, verifica progreso y termina por éxito, bloqueo, budget o decisión humana.',
    },
  ],
};
