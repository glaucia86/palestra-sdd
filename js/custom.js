...
/* ---------------------------------------------------------------------------
   3c. Special Slide Background Classes (Reveal background layer)
   --------------------------------------------------------------------------- */
function syncSpecialSlideBackgrounds(currentSlide) {
  ...
  document.querySelectorAll('.reveal .backgrounds .slide-background.bg-sobre-mim')
