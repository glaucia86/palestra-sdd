const quizDataByLocale = {
    'pt-BR': [
        ...
        },
        {
            ...
            correct: 2,
            explanation: '✅ Correto! O Harness Engineering fecha o loop: enquanto SDD define "o quê" através de specs e critérios de aceite, o Harness transforma esses critérios em gates operacionais reais que bloqueiam, alertam ou exigem revisão quando a entrega não corresponde ao especificado.',
        },
    ],
    'en-US': [
        {
        ...
        },
        {
            ...
            correct: 2,
            explanation: '✅ Correct! Harness Engineering closes the loop: while SDD defines "what" through specs and acceptance criteria, the Harness transforms those criteria into real operational gates that block, alert, or require review when the delivery does not match the spec.',
        },
    ],
    'es-ES': [
        {
        ...
        },
        {
            ...
            correct: 2,
            explanation: '✅ ¡Correcto! El Harness Engineering cierra el ciclo: mientras SDD define "qué" a través de specs y criterios de aceptación, el Harness convierte esos criterios en gates operacionales reales que bloquean, alertan o exigen revisión cuando la entrega no corresponde a lo especificado.',
        },
    ],
};
