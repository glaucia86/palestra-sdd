...
const VALIDATION_MESSAGES = {
    'pt-BR': {
        ...
        invalidOptionsCount: (qNum) => `Questão ${qNum}: "options" deve ter ao menos 2 itens.`,
        invalidOptionsValue: (qNum) => `Questão ${qNum}: todas as "options" devem ser texto.`,
    ...
    'en-US': {
        ...
        invalidOptionsCount: (qNum) => `Question ${qNum}: "options" must have at least 2 entries.`,
        invalidOptionsValue: (qNum) => `Question ${qNum}: every "option" must be text.`,
    ...
    'es-ES': {
        ...
        invalidOptionsCount: (qNum) => `Pregunta ${qNum}: "options" debe tener al menos 2 elementos.`,
        invalidOptionsValue: (qNum) => `Pregunta ${qNum}: todas las "options" deben ser texto.`,
